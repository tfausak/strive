...
instance CityLens UpdateCurrentAthleteOptions (Maybe String) where city r = (updateCurrentAthleteOptions_city r, \ v -> r { updateCurrentAthleteOptions_city = v })
...
instance CountryLens UpdateCurrentAthleteOptions (Maybe String) where country r = (updateCurrentAthleteOptions_country r, \ v -> r { updateCurrentAthleteOptions_country = v })
...
instance SexLens UpdateCurrentAthleteOptions (Maybe Char) where sex r = (updateCurrentAthleteOptions_sex r, \ v -> r { updateCurrentAthleteOptions_sex = v })
...
instance StateLens UpdateCurrentAthleteOptions (Maybe String) where state r = (updateCurrentAthleteOptions_state r, \ v -> r { updateCurrentAthleteOptions_state = v })
...
instance WeightLens UpdateCurrentAthleteOptions (Maybe Double) where weight r = (updateCurrentAthleteOptions_weight r, \ v -> r { updateCurrentAthleteOptions_weight = v })
